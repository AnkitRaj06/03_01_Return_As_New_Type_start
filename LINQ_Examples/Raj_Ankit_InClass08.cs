...
namespace LINQ_Examples
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Below are the customer names and purchases");
            foreach(var cust1 in customerPurchaseQuery)
            {
                Console.WriteLine("{0}, {1}", cust1.Name, cust1.Purchase);
            }

            Console.WriteLine("\nBelow are the customer names and price in euros");
            foreach (var cust2 in inEurosQuery)
            {
                Console.WriteLine("{0}, {1}", cust2.Name, cust2.Price);
            }
